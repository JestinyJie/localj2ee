...
<body>
	<table border="0" width="900px">
		<tr>
			<td width="39%" align="left" style="font-size: 34px; color: #999">
				部门管理</td>
			<td width="57%" align="right"><a
				href="${pageContext.request.contextPath }/department_saveUI.action"><img
					src="${pageContext.request.contextPath }/frame/img/tianjia.png"></a>
			</td>
		</tr>
	</table>
		...
		<s:iterator value="list" var="d">
			<tbody>
				<tr>
					...
					<td align="center"><a href="${pageContext.request.contextPath }/department_edit.action?did=<s:property value='#d.did'/>">
					编辑</a></td>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="900px">
		<tr>
			<td align="right"><span>第<s:property value="currPage" />/<s:property
						value="totalPage" />页
			</span>&nbsp;&nbsp;<span>总记录数：<s:property value="totalCount" /></span> <span>
